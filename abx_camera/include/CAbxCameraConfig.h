...
#ifndef CABX_CAMERA_CONFIG_H_
#define CABX_CAMERA_CONFIG_H_
...
#define ABX_CAMERA_CONFIG_XML				CONFIG_FILE_PATH"AbxCameraConfig.xml"
...
class CAbxCameraConfig
{
public:
    CAbxCameraConfig(void);
...
public:
    AbxCameraConfig mConfig;
};

#endif /* CABX_CAMERA_CONFIG_H_ */
